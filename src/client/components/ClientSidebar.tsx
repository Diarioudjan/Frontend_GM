...
const ClientSidebar: React.FC = () => {
    ...
    return (
        <div className="z-40 w-56 h-screen bg-white dark:bg-[#0a0a0a] flex flex-col fixed left-0 top-0 border-r border-neutral-200 dark:border-[#1a1a1a] transition-colors duration-300">
