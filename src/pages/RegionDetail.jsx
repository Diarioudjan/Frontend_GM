...
const RegionDetail = () => {
  ...
  const getRegionDescription = (regionId) => {
    const descriptions = {
  ...
  const getRegionShippingCost = (regionId) => {
    const costs = {
      'conakry': 5000,
      'kindia': 8000,
      'kankan': 12000,
  ...
  const getRegionProducts = (regionId) => {
    const allProducts = [
      {
        id: 1,
  ...
  const getRegionNameFromId = (regionId) => {
    const regionsMap = {
      '1': 'Basse Guinée',
      '2': 'Moyenne Guinée',
      '3': 'Haute Guinée',
  ...
  const getRegionBackgroundImage = (regionId) => {
    const images = {
