  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'large': '0 10px 40px -10px rgba(0, 0, 0, 0.15), 0 2px 10px -2px rgba(0, 0, 0, 0.10)',
        'soft-orange': '0 10px 40px -10px rgba(249, 115, 22, 0.3), 0 2px 10px -2px rgba(249, 115, 22, 0.1)',
